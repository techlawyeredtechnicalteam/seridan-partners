	...
	return (
		<div className="w-max flex items-center gap-x-3 md:gap-x-5">
			<button
				...
				className="bg-light-gray w-[35px] h-[35px] rounded-lg flex items-center justify-center rotate-[90deg] disabled:cursor-not-allowed">
